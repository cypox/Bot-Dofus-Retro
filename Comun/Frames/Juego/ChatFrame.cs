        ...
        public void get_Mensajes_Chat(TcpClient cliente, string paquete)
        {
            ...
            switch (separador[0])
            {
                ...
                case "F":
                    ...
                    if (separador[3] == ".chef")
                    {
                        int chef = int.Parse(separador[1]);
                        cliente.account.chef = chef;
                        cliente.account.Logger.log_privado("CHEF", "J'ai un nouveau chef et c'est le " + chef);
                        cliente.account.Logger.log_privado("CHEF", separador[2] + ", I will follow you to the death!");
                    }
                break;
